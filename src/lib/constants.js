...
export const ACTIVITIES = [
  { id: 'brunch',  icon: '🍳', name: 'Brunch',        time: '12:15 – 2:00 PM',          fire: false, location: 'Les Enfants Terribles',     address: "100 Av. de l'Équinoxe, Brossard", cost: '~$20/person' },
  { id: 'skeet',   icon: '🎯', name: 'Skeet Shooting', time: '2:00 – 4:00 PM',            fire: false, location: 'Club de la Roue du Roy',    address: '882 Quest Road, Hemmingford, QC J0L 1J0', cost: '~$100–$150/person' },
